import { setStyleLayer } from '#internal/dom/styles.js';
...
} from '../node/modifier-types.js';
import { getNodeState, isGuiNode, isModifierState } from '../node/registry.js';
import { composeStyles, type Styles } from './style-output.js';
