...
import { toTreeString } from '../systems/hierarchy/formatting.js';
import { setParent } from '../systems/hierarchy/mutation.js';
import {
  children,
  descendants,
  findFirstChild,
  ...
  getFullName,
  getParent,
} from '../systems/hierarchy/queries.js';
import * as lifecycle from '../systems/lifecycle.js';
import {
  getNodeProperty,
  setNodeProperties,
  subscribeToPropertyChange,
} from '../systems/properties.js';
import type { InstanceClassName, InstanceOf } from './class-map.js';
...
const methodTable = {
  isA<ClassName extends InstanceClassName>(
    ...
    return getClassName(this) === className;
  },
